      ...
      >
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="space-y-10">
            ...
            {/* CTAs */}
            <motion.div variants={staggerItem} className="flex w-full items-center gap-3 sm:w-auto sm:flex-wrap sm:gap-4">
              <motion.button
            ...
            {/* Stats */}
            <motion.div variants={staggerItem} className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 pt-4 border-t border-border/30">
